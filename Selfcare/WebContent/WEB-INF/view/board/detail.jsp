...
<body>
	<form method="post">
		...
		<br>
		<input type="submit" value="수정" onclick="javascript: form.action='/shop/front/board/update';"/>
		<input type="submit" value="삭제" onclick="javascript: form.action='/shop/front/board/delete';"/>
		<input type="submit" value="취소" onclick="javascript: form.action='/shop/front/board/cancel';"/>
	</form>
